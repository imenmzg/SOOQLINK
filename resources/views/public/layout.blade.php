        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-4 gap-12 mb-12">
                <div>
                    ...
                    <p class="text-slate-400 text-sm leading-relaxed">منصة ربط الشركات بالموردين الموثوقين في الجزائر. حلول B2B متكاملة وسهلة الاستخدام.</p>
                </div>
                <div>
                    <h4 class="font-bold mb-6 text-lg">المنتج</h4>
                    <ul class="space-y-3 text-sm text-slate-400">
                        <li><a href="{{ route('products.index') }}" class="hover:text-white transition-colors">المنتجات</a></li>
                        <li><a href="{{ route('home') }}" class="hover:text-white transition-colors">الصفحة الرئيسية</a></li>
                        <li><a href="/supplier/register" class="hover:text-white transition-colors">انضم كمورد</a></li>
                        <li><a href="/client/register" class="hover:text-white transition-colors">انضم كعميل</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="font-bold mb-6 text-lg">الشركة</h4>
                    <ul class="space-y-3 text-sm text-slate-400">
                        <li><a href="#" class="hover:text-white transition-colors">من نحن</a></li>
                        <li><a href="#" class="hover:text-white transition-colors">كيف تعمل المنصة</a></li>
                ...
                <div>
                    <h4 class="font-bold mb-6 text-lg">تابعنا</h4>
                    ...
                    <p class="text-sm text-slate-400">البريد الإلكتروني: info@sooqlink.com</p>
                </div>
            </div>
            <div class="border-t border-slate-800 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center gap-4">
                    <p class="text-sm text-slate-400">&copy; {{ date('Y') }} SOOQLINK. جميع الحقوق محفوظة.</p>
                    <div class="flex gap-6 text-sm text-slate-400">
                        ...
                        <a href="#" class="hover:text-white transition-colors">سياسة ملفات تعريف الارتباط</a>
                    </div>
                </div>
            </div>
        </div>
