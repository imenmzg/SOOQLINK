    ...
    <div class="bg-white border-b border-gray-100">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <nav class="flex items-center gap-2 text-sm">
                <a href="{{ route('home') }}" class="text-gray-500 hover:text-[#32A7E2] transition-colors">الرئيسية</a>
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
                <a href="{{ route('products.index') }}" class="text-gray-500 hover:text-[#32A7E2] transition-colors">المنتجات</a>
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
                ...
                <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
                    ...
                    <div class="space-y-4 mb-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="text-xs text-gray-500 mb-0.5">المورد</div>
                        ...
                        @if($product->supplier->average_rating > 0)
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="text-xs text-gray-500 mb-0.5">التقييم</div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="text-xs text-gray-500 mb-0.5">الفئة</div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <div class="text-xs text-gray-500 mb-0.5">الكمية المتاحة</div>
                                <div class="text-base font-bold text-slate-900">{{ $product->quantity }} وحدة</div>
                            </div>
                        </div>
                        ...
                        @if($product->wilaya)
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="text-xs text-gray-500 mb-0.5">الولاية</div>
