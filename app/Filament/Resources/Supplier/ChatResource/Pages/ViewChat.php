...
class ViewChat extends ViewRecord
{
    ...
    protected static string $view = 'filament.resources.supplier.chat-resource.pages.view-chat';
    ...
    public function sendMessage(): void
    {
        ...
        // Notify client
        $this->record->client->notify(new \App\Notifications\NewMessageNotification($message));
